...
export const PETITION_MODELS: PetitionModel[] = [
  ...
  {
    id: 'civ-evict-change',
    title: 'عريضة دعوى ﺇﺧﻼﺀ ﻹﺟﺮﺍﺀ ﺗﻐﻴﺮﺍﺕ ﺟﻮﻫﺮﻳﺔ',
    category: Category.CIVIL,
